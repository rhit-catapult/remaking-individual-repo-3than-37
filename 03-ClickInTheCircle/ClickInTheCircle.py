    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                accuracy = distance(circle_center, pygame.mouse.get_pos())
                if accuracy <= circle_radius:
                    message_text = ("yippe")
                    pygame.mixer.music.play(-1)
                else:
                    message_text = ("krill issue")
        ...
        message_font = font.render(message_text, True, (122, 237, 201))
        screen.blit(message_font, (20, 360))
